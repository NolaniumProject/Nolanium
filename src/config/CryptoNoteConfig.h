...
namespace CryptoNote
{
  namespace parameters
  {
    ...
    const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX                 = 0x7a00;                          /* Wallet addresses prefix: Na1 */
    ...
    const uint64_t BLOCK_REWARD                                            = UINT64_C(4'00000000);            /* Miner Reward: 4.00000000 NLM */
    const uint64_t GENESIS_BLOCK_REWARD                                    = UINT64_C(800'000'00000000);      /* Premine Reward: 800'000.00000000 NLM (1%) */

    const uint64_t BLOCK_REWARD_P2                                         = UINT64_C(2'00000000);            /* Miner Reward: 2.00000000 NLM */
    const uint64_t MASTERNODE_BLOCK_REWARD_P2                              = UINT64_C(3'00000000);            /* Masternode Reward: 3.00000000 NLM (75%) */
    const uint64_t STAKING_BLOCK_REWARD_P2                                 = UINT64_C(1'00000000);            /* Staking Reward: 1.00000000 NLM (25%) */

    const uint64_t BLOCK_REWARD_P3                                         = UINT64_C(2'00000000);            /* Miner Reward: 2.00000000 NLM */
    const uint64_t MASTERNODE_BLOCK_REWARD_P3                              = UINT64_C(4'00000000);            /* Masternode Reward: 4.00000000 NLM (75%) */
    const uint64_t STAKING_BLOCK_REWARD_P3                                 = UINT64_C(2'00000000);            /* Staking Reward: 2.00000000 NLM (25%) */
    
    const uint64_t PON_BLOCK_REWARD                                        = UINT64_C(1'00000000);            /* PoN Reward: 1.00000000 NLM */
    ...
    const char GENESIS_COINBASE_TX_HEX[] = 
      "010a01ff00018088debe01029b2e4c0281c0b02e7c53291a94d1d0cbff8883f8024f5142ee494ffbbd0880712101e5464a68a75fa80b1150be0bfcf45abe37dbdc74056018af0d94d8373bb2fc98";
  ...
  const char    CRYPTONOTE_NAME[]                                          = "Nolanium";
  ...
  const char LATEST_VERSION_URL[]                                          = "https://github.com/NolaniumProject/Nolanium/releases";
  const std::string LICENSE_URL                                            = "https://github.com/NolaniumProject/Nolanium/blob/master/LICENSE";
  ...
  const char *const SEED_NODES[] = {
    "85.148.143.163:21000",
    "85.148.143.163:21100"
  };
}
