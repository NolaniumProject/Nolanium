...
namespace WalletConfig
{
    ...
    const std::string_view addressPrefix = "Na1";

    /* Your coins 'Ticker', e.g. Monero = XMR, Bitcoin = BTC */
    const std::string ticker = "NLM";
    ...
    const std::string daemonName = "Nolaniumd";

    /* The name to call this wallet */
    const std::string walletName = "Nolanium-Wallet";

    /* The name of service/walletd, the programmatic rpc interface to a
       wallet */
    const std::string walletdName = "Nolanium-Service";
